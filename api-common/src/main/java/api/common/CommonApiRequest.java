...
public class CommonApiRequest implements ApiRequest {
    ...
    public CommonApiRequest(String baseUri, String basePath, String parameterName, String parameterValue) {
        httpRequest = RestAssured.given();
        withBaseUri(baseUri).withBasePath(basePath).withQueryParam(parameterName, parameterValue).withContentType(ContentType.JSON);
    }

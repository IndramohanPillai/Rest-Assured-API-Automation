...
public class ApiClient {
    ...
    public ApiClient(String baseUrl,String basePath, String parameterName, String parameterValue) {
        Log = LoggerFactory.getLogger(this.getClass().getSimpleName());
        request = new CommonApiRequest(baseUrl, basePath, parameterName, parameterValue);
        caller = new ApiCaller();
        Log.info("Initiated "+ this.getClass().getName()+" instance");
    }
